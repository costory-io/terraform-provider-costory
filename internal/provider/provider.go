...
func (p *costoryProvider) Resources(_ context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		...
		billingdatasource.NewAnthropicClaudeAiResource,
		billingdatasource.NewElasticCloudResource,
		billingdatasource.NewAzureResource,
		billingdatasource.NewClickHouseCloudResource,
		billingdatasource.NewCloudflareResource,
		billingdatasource.NewScalewayResource,
		billingdatasource.NewOpenAIResource,
		billingdatasource.NewCustomBigQueryResource,
		billingdatasource.NewConfluentResource,
		billingdatasource.NewDatadogResource,
		billingdatasource.NewAivenResource,
		billingdatasource.NewGCPCUDExportResource,
		billingdatasource.NewSnowflakeResource,
		team.NewResource,
